      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-[48px] overflow-hidden shadow-xl border-[12px] border-white bg-white group">
              <motion.img
                whileHover={{ scale: 1.05 }}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#003399]/90 via-[#003399]/30 to-transparent flex flex-col justify-end p-16">
                <span className="text-white font-black text-7xl tracking-tight mb-2">
                  14+
                </span>
                <span className="text-blue-200 uppercase tracking-[0.4em] font-black text-xs">
            ...
            <motion.div
              ...
              className="absolute -right-10 top-24 bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-white/60 hidden xl:block max-w-[260px]"
            >
              <h4 className="text-[#003399] font-black uppercase tracking-widest text-xs mb-4">
                Strategic Ethos
              </h4>
              <p className="text-lg font-bold text-gray-800 leading-tight">
                Architecting Digital Market Leadership
              </p>
              <div className="w-12 h-1 bg-[#ED1C24] mt-6 rounded-full" />
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <span className="inline-block text-[#ED1C24] font-black uppercase tracking-[0.5em] mb-6 text-xs">
              The Visionaries
            </span>

            <h2 className="text-5xl md:text-6xl font-black text-[#003399] mb-10 tracking-tight leading-tight">
              Elite Strategy <br />
              <span className="serif italic font-normal text-sky-500">
            ...
            <div className="space-y-8">
              <ScrubHighlight
                className="text-2xl font-bold text-gray-800 leading-relaxed"
                text="Marketing is an essential element of business strategy, requiring ongoing focus in today's fast-paced digital environment."
              />

              <p className="text-lg text-gray-500 leading-relaxed font-medium">
                Effective marketing ensures <span className="text-[#003399] font-bold underline decoration-[#ED1C24] decoration-2 underline-offset-4">
                  brand visibility
                </span>, customer education, and clear communication of promotional value. 
                Our team is committed to elevating your brand presence.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { icon: <BarChart3 size={20} />, label: "Actionable Insights" },
                { icon: <Target size={20} />, label: "Business Outcomes" },
                { icon: <ShieldCheck size={20} />, label: "Brand Building" },
                { icon: <ArrowRight size={20} />, label: "Professional Reach" }
              ].map((item, index) => (
                <div key={index} className="flex items-center gap-4 group">
                  <div className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center text-[#003399] border border-gray-200 group-hover:bg-[#003399] group-hover:text-white transition-colors">
                    {item.icon}
                  </div>
            ...
            <motion.button
              whileHover={{ x: 6 }}
              className="mt-16 flex items-center gap-6 group"
            >
              <span className="text-lg font-black text-[#003399] uppercase tracking-widest border-b-2 border-[#ED1C24]">
                Discover Our Ethos
              </span>
              <div className="w-14 h-14 rounded-full border-2 border-gray-200 flex items-center justify-center text-[#003399] group-hover:bg-[#003399] group-hover:text-white group-hover:border-[#003399] transition-all duration-300">
                <ArrowRight size={20} />
              </div>
            </motion.button>
